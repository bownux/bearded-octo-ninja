...
public class OldGameAgainstNewGameTests extends BaseSeriesMethodTestFixture {
	...
	public void testNewGameBeatsOrDrawsOldGameMostOfTheTime() throws Exception {
		...
		playOldGameAgainstNewGame(numberOfGamesToPlay);
		prepareResults(numberOfGamesToPlay, startTime);
		printResults(numberOfGamesToPlay);
	...
	private void playOldGameAgainstNewGame(int totalGamesPlayed) {
