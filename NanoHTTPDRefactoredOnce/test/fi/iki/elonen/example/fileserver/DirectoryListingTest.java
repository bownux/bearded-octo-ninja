...
public class DirectoryListingTest extends FileServerExampleTestBase {
	...
	private static final String RESOURCE_FOLDER_CONTENTS = "<html><body><h1>Directory /</h1><br/><a href=\"/testFile1.txt\">testFile1.txt</a> &nbsp;<font size=2>(13 bytes)</font><br/><a href=\"/testFile2.txt\">testFile2.txt</a> &nbsp;<font size=2>(13 bytes)</font><br/>";
	private static final String SECOND_LEVEL_FOLDER_2_FOR_TEST = "resources\\rootLevelFolder\\secondLevelFolder_2";
	private static final String THIRD_LEVEL_FOLDER_FOR_TEST = "resources\\rootLevelFolder\\secondLevelFolder_1\\thirdLevelFolder_1";
	private static final String ROOT_LEVEL_FOLDER_FOR_TEST = "resources\\rootLevelFolder";
	...
	public void canDisplayRegularDirectoryContents() {
		lister.setFile(new File(DOT_SLASH + SECOND_LEVEL_FOLDER_2_FOR_TEST));	
		lister.setUri(SECOND_LEVEL_FOLDER_2_FOR_TEST);
		System.out.println(lister.getUri());
		
		response = lister.showDirectoryOrFile();
		dataStream = response.getData();
		assertEquals(RESOURCE_FOLDER_CONTENTS, convertStreamToString(dataStream));
		
		//<html><body>Redirected: <a href="\resources\rootLevelFolder\secondLevelFolder_2/">\resources\rootLevelFolder\secondLevelFolder_2/</a></body></html>
	}
