...
public class StartupTest extends FileServerExampleTestBase {
	...
	@Test
	public void xxx() {
		FileServerExample.printInstructions(sloppyLogger, 8090);
		verifySaysHowdy();	
	}
	...
	public void canStart() {
		String lf = LINE_FEED;
		InputStream reader = new ByteArrayInputStream(lf.getBytes());
		FileServerExample.setInputReader(reader);
		FileServerExample.setSloppyLogger(sloppyLogger);
		FileServerExample.start(new String[]{});
